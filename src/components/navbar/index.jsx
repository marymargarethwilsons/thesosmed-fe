          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex justify-between">
            <div className="flex">
              ...
              <Link to={"/"} className="flex justify-between flex-shrink-0 items-center w-40 md:w-52">
                <Logo fill={`${theme === 'light' ? '#7B66FF' : '#5FBDFF'}`} className="w-12 h-12 md:w-16 md:h-16"/>
            ...
            <div className="flex h-16 justify-end space-x-16 w-full">
              ...
              <div className="flex items-center  md:space-x-8">
                <div className="flex">
                  <button
                    type="button"
                    className={`${theme === 'light' ? 'bg-navlight':'bg-navdark'} inline-flex items-center rounded-xl border border-transparent space-x-1 md:space-x-2 px-3 md:px-3 py-2 md:py-3 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2`}
                  >
                    <Whatsapp className="md:w-7 md:h-7 w-5 h-5" />
                    <span className="text-xs md:text-base">Kontak Saya</span>
                  </button>
                </div>
